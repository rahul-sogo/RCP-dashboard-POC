...
export const APP_TABLE_CONFIG = {
    defaultHeight: 400, // Default height for the table
    stickyHeader: true, // Ensures the table header stays visible on scroll
    columnDefaults: {
      minWidth: 100,
      align: 'left', // Default alignment for table cells
    },
  };
